    ...
    <div className='bg-white shadow-lg rounded-lg pb-12 mb-8'>
        ...
        <div className='px-4 lg:px-8'>
          <div className='flex items-center mb-8 w-full'>
            <div className='hidden md:flex items-center px-3 justify-center lg:mb-0 lg:w-auto mr-8'>
              <img 
            ...
            <div className='font-medium text-gray-700 w-full flex align-middle md:justify-end'>
